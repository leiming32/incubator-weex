        ...
        <panel title="border" type="primary">
            <panel title="border-width" type="">
                <div style="flex-direction: row;">
                    ...
                    <style-item style="border-style: solid;border-width: 10px;border-color: #333;"
                                value=""></style-item>
                    <style-item style="border-style: solid;border-left-width: 4px;border-color: #333;"
                                value=""></style-item>
                    <style-item style="border-style: solid;border-bottom-width: 4px;border-color: #333;"
                                value=""></style-item>
                </div>
            </panel>
            ...
            <panel title="border-style" type="">
                ...
                <div style="flex-direction: row;">
                    <style-item style="border-style: solid;border-width: 4px;border-color: #333;" value=""></style-item>
                    <style-item style="border-style: dashed;border-width: 4px;border-color: #333;" value=""
                                type=""></style-item>
                    <style-item style="border-style: dotted;border-width: 4px;border-color: #333;"
                                value=""></style-item>
                </div>
            </panel>
            <panel title="border-radius" type="">
                <div style="flex-direction: row;">
                    ...
                    <style-item style="border-bottom-left-radius:20px;border-bottom-right-radius:20px"
                                value=""></style-item>
                </div>
            </panel>
        </panel>
